...
## How To Use This Project On Your GitHub Profile

1. Create a new GitHub repository named `coffee-shop-sql-analysis`.
2. Upload these files.
3. Add the repository to your profile README under a `Featured Projects` section.
4. Include a short description like:

> SQL portfolio project analyzing fictional coffee shop sales using joins, CTEs, window functions, and customer segmentation.
